...
The microRNAome of the 196 primary cells was processed as described in [GigaScience](https://academic.oup.com/gigascience/article/doi/10.1093/gigascience/giac083/6675300), a sample run is shown below:
...
```{r load_example_data}
data("ERCC_filtered.rda")
```

#### The description of the miRge3.0 parameters used above can be found [here](https://github.com/mhalushka/miRge3.0/)
